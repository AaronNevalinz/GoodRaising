<nav class="col-span-1 flex flex-col gap-y-1 mt-4 fixed font-hanken">
    <a href="{{route('dashboard.index')}}" class="hover:bg-accent text-white py-2 px-2  rounded-lg hover:text-secondary transition-all">Dashboard</a>
    <a href="{{route('organization')}}" class="hover:bg-accent text-white py-2 px-2  rounded-lg hover:text-secondary transition-all ">Organization</a>
