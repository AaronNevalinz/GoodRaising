...
@section('content')
    <section class="mt-0.5">
        ...
        <div class="py-16 max-w-xl mx-auto text-center text-slate-600">
        ...
        <div class="py-16 bg-gray-300 space-y-6">
            <h1 class="text-slate-900 font-medium text-3xl text-center mb-10">How it Works</h1>
            <div class="flex gap-5 px-20">
                <div class="bg-white flex flex-col items-center py-4 px-8">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-10 fill-secondary">
                    ...
                    <p class="text-center py-3 text-sm text-slate-700">
                    ...
                    <p class="uppercase text-secondary font-bold text-xs">nonprofits</p>
                </div>
                
                <div class="bg-white flex flex-col items-center py-4 px-8">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-10 fill-primary">
                    ...
                    <p class="uppercase text-primary font-bold text-xs">Donors</p>
                </div>
                <div class="bg-white flex flex-col items-center py-4 px-8">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-10 fill-slate-800">
                    ...
                    <p class="uppercase text-secondary font-bold text-xs">Companies</p>
                </div>
                <div class="bg-white flex flex-col items-center py-4 px-8">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-10 fill-primary">
                    ...
                    <p class="uppercase text-secondary font-bold text-xs">Our impact</p>
                </div>
        ...
        <div class="flex h">
            <div class="flex-1 flex justify-center items-center">
                <div class="max-w-lg text-center space-y-8 text-slate-900">
                    <h1 class="text-4xl">Disaster Recovery</h1>

                    <p class="text-lg leading-7">
                        GlobalGiving makes it easy to donate to reliable, locally-led disaster relief and recovery efforts around the world.
                    </p>
        ...
        {{-- coporate partners --}}
        <div class="max-w-3xl mx-auto text-center space-y-8 py-16">
            <h1 class="text-4xl">Our Corporate Partners</h1>
            <p>
            ...
            <div>
                <a href="" class="border border-blue-900 text-blue-900 px-4 py-2 uppercase text-sm font-medium">View all companies</a>
            </div>
        </div>
        ...
        {{-- news --}}
        <div class="bg-slate-300 py-8 pb-16">
            <h1 class="text-center text-4xl py-8">News</h1>
            <div class="flex items-center max-w-6xl mx-auto gap-5">
                <div class="bg-white">
                    <img src="images/learn-feature-poetry-book.jpg" alt="">
                    <div class="text-center px-8 py-5">
                        <p class="font-bold">Together Under the Sky</p>
                        <p class="my-4 text-slate-600">Explore poems from around the world written by change leaders from the GlobalGiving community.</p>
                        <a href="" class="text-primary hover:underline uppercase text-sm font-bold">Download the Book</a>
                    </div>
                </div>
                <div class="bg-white">
                    ...
                    <div class="text-center px-8 py-5">
                        ...
                        <a href="" class="text-primary hover:underline uppercase text-sm font-bold">Explore Now</a>
                    </div>
                </div>
                <div class="bg-white">
                    <img src="images/disaster-white-paper.png" alt="">
                    <div class="text-center px-8 py-5">
                        <p class="font-bold capitalize">Impact Beyond the polls</p>
                        <p class="my-4 text-slate-600">
                            Our latest white paper uncover the hidden toll of disaster on vulnerable communities
                        </p>
                        <a href="" class="text-primary hover:underline uppercase text-sm font-bold">Read Now</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        {{-- subscribe --}}
        <div class="flex flex-col items-center py-28 max-w-2xl space-y-4 mx-auto">
            <p class="text-lg text-slate-700">Get incredible stories, promotions, and matching offers in your inbox</p>
            <form action="" class="flex">
                <input type="text" class="bg-slate-200 py-2 px-4 outline-none">
                <button class="uppercase bg-accent text-white px-4 font-medium">Subscribe</button>
            </form>
        </div>
    </section>
@endsection